    ...
    def __call__(self, feature):
        ...
        for scale_index in range(self.num_scale):
            ...
            if cfg.ModelOutput.MINOR_CTGR:
                ...
                decoded["mark_dont"].append(mu.sigmoid_with_margin(feature["mark_dont"][scale_index], 0, 0, 1))
                decoded["mark_do"].append(mu.sigmoid_with_margin(feature["mark_do"][scale_index], 0, 0, 1))
