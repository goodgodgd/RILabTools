...
def draw_boxes(image, bboxes, category_names, locations=None, box_format="yxhw", frame_name=None):
    ...
    for i, bbox in enumerate(bboxes):
        ...
        elif major_category == "Road mark dont":
            image = cv2.putText(image, f"{i}{category_names['mark_dont'][minor_cat_index]}", pt1, cv2.FONT_HERSHEY_SIMPLEX,
                                0.5, (0, 0, 255), 2)
        elif major_category == "Road mark do":
            image = cv2.putText(image, f"{i}{category_names['mark_do'][minor_cat_index]}", pt1, cv2.FONT_HERSHEY_SIMPLEX,
                                0.5, (0, 0, 255), 2)
        else:
