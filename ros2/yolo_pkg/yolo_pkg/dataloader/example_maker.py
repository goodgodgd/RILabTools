    ...
    def merge_box_and_category(self, bboxes, categories):
        ...
        for category_str in categories:
            if category_str in self.category_names["major"]:
                ...
                speed_index = -1
            elif category_str in self.category_names["mark_dont"]:
                major_index = self.category_names["major"].index("Road mark dont")
                minor_index = self.category_names["mark_dont"].index(category_str)
                speed_index = -1
            elif category_str in self.category_names["mark_do"]:
                major_index = self.category_names["major"].index("Road mark do")
                minor_index = self.category_names["mark_do"].index(category_str)
                speed_index = -1
